      ...
      <div id="sidebarMenu" class="sidebar-body">
        <div class="nav-group show">
          ...
          <ul class="nav nav-sidebar">
            <li class="nav-item">
              <a href="./dashboard" class="nav-link active"><i class="ri-pie-chart-2-fill"></i> <span>Dashboard</span></a>
            </li>
          </ul>
        </div><!-- nav-group -->
        <div class="nav-group show">
          <a href="#" class="nav-label">Ecommerce</a>
          <ul class="nav nav-sidebar">
            <li class="nav-item">
              <a href="" class="nav-link has-sub"><i class="ri-gallery-line"></i> <span>Products</span></a>
              <nav class="nav nav-sub">
                <a href="./products.php" class="nav-sub-link">Products</a>
                <a href="./product-add.php" class="nav-sub-link">Add Products</a>
                <a href="./product-variants.php" class="nav-sub-link">Add Varriations</a>
              </nav>
            </li>
            <li class="nav-item">
              <a href="" class="nav-link has-sub"><i class="ri-gallery-line"></i> <span>Categories</span></a>
              <nav class="nav nav-sub">
            ...
            <li class="nav-item">
              <a href="" class="nav-link has-sub"><i class="ri-gallery-line"></i> <span>Brands</span></a>
              <nav class="nav nav-sub">
                <a href="./apps/gallery-music.html" class="nav-sub-link">Music Stream</a>
                <a href="./apps/gallery-video.html" class="nav-sub-link">Video Stream</a>
              </nav>
            ...
            <li class="nav-item">
              <a href="" class="nav-link has-sub"><i class="ri-gallery-line"></i> <span>Inventory</span></a>
              <nav class="nav nav-sub">
                <a href="./apps/gallery-music.html" class="nav-sub-link">Music Stream</a>
                <a href="./apps/gallery-video.html" class="nav-sub-link">Video Stream</a>
              </nav>
            ...
            <li class="nav-item">
              <a href="" class="nav-link has-sub"><i class="ri-gallery-line"></i> <span>Orders</span></a>
              <nav class="nav nav-sub">
                <a href="./apps/gallery-music.html" class="nav-sub-link">Music Stream</a>
                <a href="./apps/gallery-video.html" class="nav-sub-link">Video Stream</a>
              </nav>
            ...
            <li class="nav-item">
              <a href="" class="nav-link has-sub"><i class="ri-gallery-line"></i> <span>Customers</span></a>
              <nav class="nav nav-sub">
                <a href="./customers.php" class="nav-sub-link">Customers</a>
                <a href="./customer-view.php" class="nav-sub-link">Customers View</a>
                <a href="./customer-orders.php" class="nav-sub-link">Customers Orders</a>
              </nav>
            </li>
            <li class="nav-item">
              <a href="./reviews.php" class="nav-link"><i class="ri-gallery-line"></i> <span>Reviews</span></a>
            </li>
          </ul>
        </div><!-- nav-group -->
        <div class="nav-group show">
